...
void backHow(int buttonX, int buttonY, int buttonWidth, int buttonHeight);
void backAbout(int buttonX, int buttonY, int buttonWidth, int buttonHeight);
void howPage();
void aboutPage();
void turnMusicOff();
...
int main()
{
	...
	while (1)
	{
		...
		else if (pagecheck == 2)
		{
			...
			{
				howPage();
				backHow(60,38,185,100);
			}
			aboutUsButton(510,516,345,85);
			if (about != 0)
			{
				aboutPage();
				backAbout(60,38,185,100);
			}
